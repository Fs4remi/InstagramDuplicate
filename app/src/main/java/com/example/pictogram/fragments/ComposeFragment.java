    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        ((Button)view.findViewById(R.id.submit)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(desc.isEmpty()){
                    Toast.makeText(view.getContext(), "Post needs a description", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(photoFile == null || photo.getDrawable() == null){
                    Toast.makeText(view.getContext(), "Post needs a photo", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e != null){
                    ...
                    Toast.makeText(getContext(), "Posted pic", Toast.LENGTH_SHORT).show();
                    description.setText("");
